...
def preprocess_input(image_path, patient_age, patient_sex, view_position, scaler, age_scaler, sex_enc, view_enc):
    ...
    x_encoded = encode_scale_input_features(df, x_img, scaler, age_scaler, sex_enc, view_enc)
    return x_encoded
...
def predict(image_path, patient_age, patient_sex, view_position,
    ...
    x_encoded = preprocess_input(image_path, patient_age, patient_sex, view_position, scaler, age_scaler, sex_enc, view_enc)
